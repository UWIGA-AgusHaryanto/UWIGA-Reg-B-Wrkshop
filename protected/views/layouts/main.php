	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Pengguna', 'url'=>array('/TbUsers')),                                
                                array('label'=>'Email', 'url'=>array('/Email')),
                                array('label'=>'Product', 'url'=>array('/Product')),
                                array('label'=>'Product Price', 'url'=>array('/Productprice')),
                                ...
                                array('label'=>'Cust Payment', 'url'=>array('/Payment')),                                
